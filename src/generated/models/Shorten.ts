...
// @ts-nocheck 
/*
 * This file exports the `Shorten` model and its related types.
 *
...
export type GetShortenAggregateType<T extends ShortenAggregateArgs> = {
      [P in keyof T & keyof AggregateShorten]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateShorten[P]>
    : Prisma.GetScalarType<T[P], AggregateShorten[P]>
}
...
type GetShortenGroupByPayload<T extends ShortenGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<ShortenGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof ShortenGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], ShortenGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], ShortenGroupByOutputType[P]>
      }
    >
  >
...
export type ShortenCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ShortenFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ShortenDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['Shorten'], meta: { name: 'Shorten' } }
  /**
   ...
   * })
  **/
  count<T extends ShortenCountArgs>(
    args?: Prisma.Subset<T, ShortenCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], ShortenCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ShortenGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetShortenGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
